...
-   Huff model is a spatial analysis tool that 
**estimates the probability of a consumer visiting a specific store** by considering the store's attractiveness and the distance to it, relative to competing stores.
